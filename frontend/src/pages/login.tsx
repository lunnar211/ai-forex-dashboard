      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-gradient-to-br from-[#0f172a] via-[#1e293b] to-[#0f172a] flex-col justify-between p-12">
        ...
        <div className="relative z-10 space-y-8">
          ...
          <div className="space-y-4">
            {[
              { icon: '🤖', title: 'AI Predictions', desc: 'Groq, OpenAI & Gemini powered signals' },
              { icon: '📊', title: 'Live Charts', desc: 'Real-time candlestick charts with indicators' },
              { icon: '⚡', title: 'Instant Signals', desc: 'EUR/USD, GBP/USD, XAU/USD & more' },
            ].map((f) => (
